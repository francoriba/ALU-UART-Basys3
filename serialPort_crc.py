...
continuar = True
BAUDRATE = 19200 #set baudrate for this comunication
...
if __name__ == "__main__":
    ...
    if selected_port:
        ...
        while continuar:
            ...
            response = input('Nueva operacion? y/n: ')
            if response == 'y' or response == 'Y': continuar = True
            if response == 'n' or response == 'N': continuar = False